...
#define MYPORT "22596"	// the port users will be connecting to -- UDP
...
*/
	printf("\nThe server B has received the network topology from the\n"
	...
	*/
	printf("\nFor this connection with Client, The Server B has\n"
